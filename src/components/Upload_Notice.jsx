                ...
                <table className="input_notice_table">
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <input type="text" onChange={this.titleChange.bind(this)} size="52" className="input_notice_title"/>
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                <textarea rows={10} cols={50} onChange={this.contentChange.bind(this)} className="input_notice_contents" />
                            </td>
                        </tr>
                        <tr>
                            <td>
