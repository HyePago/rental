    ...
    render(){
        ...
        let third_Form = (
            <div>
                ...
                <br />
                <span> 연료 : {this.state.fuel[this.state.division_number]} </span>
                <br />
                <span> {this.state.few[this.state.division_number]} 인승</span> 
                <br />
                <span> 색상 : {this.state.color[this.state.division_number]} </span>
                <br />
                <span> 차량 등록일 : {this.state.registration_date[this.state.division_number]} </span>
                <br />
                <span> 주행거리 : {this.state.distance[this.state.division_number]} </span>
                <br />
                <span> 대여료 : {this.state.show_cost} </span>
                <br />
                <span> 포인트 </span>
                <br />
                <span> 현재 포인트 : {cookie.load('reserves')} </span>
                <br />
                <span> 사용할 포인트 : </span> <input type="number" placeholder="사용하고 싶은 포인트" onChange={this.usepointChange.bind(this)}/>
                <br />
                포인트는 5000원 이상일 때만 사용 가능합니다.
                <br />
                <span> 자차 손핵 면책 제도(CDW) </span>
                ...
                <br />
                베이비 시트(1회 2,000원 추가)
                <input type="checkbox" onChange={this.babyseatChange.bind(this)}/> 베이비시트
                <br />
                <button onClick={this.renting_button_click.bind(this)}> 대여하기 </button>
            </div>
        )
        let fourth_Form = (
            <div>
                ...
                <br />
                <span> 이름 </span>
                <input type="text" value={cookie.load('name')} onChange={this.nameChange.bind(this)} />
                <br />
                <span> 이메일 </span>
                <input type="text" value={cookie.load('email')} onChange={this.emailChange.bind(this)} />
                <br />
                <span> 면허 구분 </span>
                <select defaultValue={cookie.load('license_category')} onChange={this.license_categoryChange.bind(this)}>
                    <option id="1" value="1">국내</option>
                    <option id="2" value="2">국외</option>
                </select>
                <br />
                <label>면허 종류</label>
                <select defaultValue={cookie.load('license_type')} onChange={this.license_typeChange.bind(this)}>
                ...
                <br />
                <label>면허증 번호</label>
                <select defaultValue={cookie.load('license_number').slice(0,1)} onChange={this.license_number_0Change.bind(this)}>
                    <option id="1" value="1">서울</option>
                    <option id="2" value="2">11</option>
                </select>
                &nbsp;
                <input type="text" size="2" maxLength={2} defaultValue={cookie.load('license_number').slice(1,3)} onChange={this.license_number_1Change.bind(this)}></input>
                -
                <input type="text" size="6" maxLength={6} defaultValue={cookie.load('license_number').slice(3,9)} onChange={this.licesne_number_2Change.bind(this)}></input>
                -
                <input type="text" size="2" maxLength={2} defaultValue={cookie.load('license_number').slice(9,11)} onChange={this.license_number_3Change.bind(this)}></input>
                <br />
                <label>면허발급일자</label>
                <input type="date" defaultValue={cookie.load('date_if_issue').slice(0,10)} onChange={this.date_if_issueChange.bind(this)}></input>
                <br />
                <label>적성검사</label>
                <input type="date" defaultValue={cookie.load("aptitude_test").slice(0,10)} onChange={this.aptitude_testChange.bind(this)}></input>
                <br/>
                <br/>
                <span> 예약완료를 위한 이용자 동의 사항 </span>
                <br />
                <input type="checkbox" onChange={this.check_0Change.bind(this)}/> 예약완료를 위한 이용 동의(필수), 차량 대여를 위한 개인정보 수집/이용 동의(필수), 개인정보 취급 위탁 동의(필수), 개인정보 제 3자 제공 동의(필수)에 모두 동의합니다.
                <br />
                <br />
                <button onClick={this.last_button_click.bind(this)}> 대여하기 </button>
            </div>
        )
        let last_Form = (
            <div>
